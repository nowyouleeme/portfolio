...
const Home = () => {
    const { ref, inView } = useInView({
        threshold: 0, initialInView: true
    });
...
`;
    ...
    useEffect(() => {
        ...
        const didScrollPage = e => {
          let calc = 1 - (window.scrollY - offset + range)/ (range + 600);
    ...
    return (
        <div id="Home">
            ...
            <div style={{ backgroundColor:"#1d1d1d"}}>
                <div style={{backgroundColor: "rgba(248, 248, 248," + opacity + ")" }}>
                    <section ref={ref} id="Landing" className="DisplayPadding">
                        <div ref={headerRef} id="LandingContent">
                            <div style={{opacity: opacity}} className="columns">
                                <div id="Display">
